    ...
    <v-card color="black">
      <v-row justify="" align="">
        <v-col cols="12" sm="12" md="12">
          <v-card color="black" height="200px" dark>
            ...
            <v-container>
              <v-row justify="center" align="center">
                <v-col cols="12" sm="12" md="12">
                  <v-card color="green" light rounded shaped>
                    <v-row>
                      <v-col cols="12" sm="12" md="12">
                        <div class="container">
                          <div class="d-flex">
                            ...
                            <div>
                              <div class="d-flex">
                                <h2 style="margin-top: 29px; font-size: 1.2rem">Ksh.</h2>
                                <div v-show="!showB" class="blur">
                                  <h1 style="font-weight: 1200; font-size: 3rem">
                                    {{ balance + 3070 }}
                                  </h1>
                                </div>
                                <div v-show="showB">
                              ...
                              <p style="color: black; margin-start: 70px">
                                <strong>Rental balance</strong>
                              </p>
                              <div class="d-flex">
                                <v-spacer />
                                <v-btn v-show="showB" icon @click="showB = false">
                                  <v-icon>mdi-eye-outline</v-icon>
                                </v-btn>
                                <v-btn
                                  v-show="!showB"
                                  icon
                                  @click="pin_view_bal_dialog = true"
                                >
                ...
                <v-col v-show="false" cols="12" sm="12" md="12">
                  <v-tabs
                    color="green"
                    center-active
                    :show-arrows="true"
                    class="text-center"
                  >
                    <v-tab v-show="!auth_state" @click="stk_push = false" value="one"
                      ><span>Refunds</span></v-tab
                    >
                    <v-tab v-show="!auth_state" value="two" @click="stk_push = true">
                      <span>Deposit</span></v-tab
                    >
                    <!-- <v-tab v-show="set_Pin" value="two" @click="(register = false), (login = false),set_Pin = true">
                <span>Set Pin</span></v-tab>
            <v-tab v-show="security_quiz" value="two" @click="(register = false), (login = false),set_Pin = false,security_quiz=true">
                <span>Security question</span></v-tab> -->
                  </v-tabs>
                </v-col>
              </v-row>
            </v-container>
        ...
        <v-col cols="12" sm="12" md="12">
          <div class="container">
            <v-tabs background-color="deep-greet accent-4" centered dark>
              <v-tab
                @click="
                  (pin_status = ''),
                    (pin_input = ''),
                ...
                "
              >
                <v-icon color="green">mdi-cash-refund</v-icon> Refund
              </v-tab>
              <v-tab
                @click="
                  (deposit = false),
        ...
        <v-col id="charter" v-show="!deposit" cols="12" sm="12" md="12">
          <div class="d-flex">
            <v-spacer />
            <div>
              <div class="d-flex">
                <div class="container">
                  <v-form ref="form" v-model="valid" lazy-validation>
                    ...
                    <v-btn
                      ...
                      @click="(pin_dialog2 = true), (pin_transact = null)"
                    >
                      Make a Deposit
                    </v-btn>
...
export default {
  ...
  methods: {
    ...
    mpesaB2cQuery() {
      axios
        .post("https://charge24rervsalserver-7ead59ad5fb9.herokuapp.com/result_url", {})
    ...
    mpesaB2c() {
      ...
      if (that.Phone == null) {
        ...
        that.show6 = true;
        axios
          .post("https://charge24rervsalserver-7ead59ad5fb9.herokuapp.com/b2c", {
